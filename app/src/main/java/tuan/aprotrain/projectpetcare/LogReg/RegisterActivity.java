package tuan.aprotrain.projectpetcare.LogReg;
...
import tuan.aprotrain.projectpetcare.activities.UserAdd;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void updateUI(FirebaseUser account){
        ...
        if(account != null){
            ...
            startActivity(new Intent(RegisterActivity.this, UserAdd.class));
